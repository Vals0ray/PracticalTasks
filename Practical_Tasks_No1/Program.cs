namespace Practical_Tasks_No1
{
    ...
    public class Program
    {
        ...
        private static void Task1()
        {
            ...
            Task1.Rectangle rectangle = new Task1.Rectangle(TopLeftCornerX, TopLeftCornerY, BottomRightCornerX, BottomRightCornerY);
        ...
        private static void Task2()
        {
            ...
            Task2.Rectangle rectangle = new Task2.Rectangle(TopLeftCornerX, TopLeftCornerY, BottomRightCornerX, BottomRightCornerY);
        ...
        private static void Task3()
        {
            ...
            Task3.Circle circle = new Task3.Circle();
        ...
        private static void Task4()
        {
            ...
            Perimeter = Practical_Tasks_No1.Task4.Rectangle.Perimeter(TopLeftCornerX, TopLeftCornerY, BottomRightCornerX, BottomRightCornerY);
            Square = Practical_Tasks_No1.Task4.Rectangle.Square(TopLeftCornerX, TopLeftCornerY, BottomRightCornerX, BottomRightCornerY);
            Console.WriteLine($"Perimetr equals {Perimeter}");
            Console.WriteLine($"Square equals {Square}\n");

            Console.WriteLine("--- Task4 Circle ---");

            Console.WriteLine($"Circuit equals {Practical_Tasks_No1.Task4.Circle.Circuit(Radius)}");
            Console.WriteLine($"CircleSquare equals {Practical_Tasks_No1.Task4.Circle.CircleSquare(Radius)}\n");
        }
        ...
        private static void Task5()
        {
            ...
            Task5.ComplexNumber c1, c2 = new Task5.ComplexNumber();
            c1 = new Task5.ComplexNumber(Real, Imaginary);
            c2 = new Task5.ComplexNumber(Real, Imaginary);

            // Multiplication
            Task5.ComplexNumber c3 = c1 * c2;
            Console.WriteLine("Multiplication result: ");
            Console.WriteLine($"c3 = {c3.R} + i * {c3.I}");

            // Division
            Task5.ComplexNumber c4 = c1 / c2;
